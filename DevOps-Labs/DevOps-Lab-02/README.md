...
Are you looking to streamline your application delivery process and automate your infrastructure deployment? Look no further! In this lab, I'll take you through the process of setting up an EKS cluster, deploying an application, and creating a CI/CD pipeline using Jenkins and Terraform.
...
We are going to build and deploy a lot of things. Here is the outline for our lab:
...
Before creating and working with the lab, let's set up some dev tools first -

1. It's better to have an IDE to develop your lab. I am using `Visual Studio Code` for the same. You can install it from the following link based on the operating system— [https://code.visualstudio.com/download](https://code.visualstudio.com/download)
