$resourceGroupName = "RG-ETISALAT-AVD"
$location = "WestEurope"
$parameters = @{
...
$galleryParameters = @{
    GalleryName       = "EtisalatAvdGallery"
    ResourceGroupName = $resourceGroupName
    Location          = $location
    Description       = "Shared Image Gallery for VMs"
}
...
$hostpoolParameters = @{
    Name                  = "Etisalat-Hostpool"
    Description           = "Etisalat Host Pool"
    ResourceGroupName     = $resourceGroupName
    Location              = $location
    HostpoolType          = "Pooled"
...
$applicationGroupParameters = @{
    ResourceGroupName    = $ResourceGroupName
    Name                 = "EtisalatApplications"
    Location             = $location
    FriendlyName         = "Applications on the AVD"
    Description          = "From the Etisalat-deployment"
...
$workSpaceParameters = @{
    ...
    Description               = "This is the place to avd"
}
$workSpace = New-AzWvdWorkspace @workSpaceParameters

$keyVaultParameters = @{
    Name              = "EtisalatKeyVault"
    ResourceGroupName = $resourceGroupName
    Location          = $location
}
...
$VMSize = "Standard_D2s_v3"
$DiskSizeGB = 512
$domainUser = "mohamed.hesham@digitech-eg.local"
$domain = $domainUser.Split("@")[-1]
$ouPath = "OU=Computers,OU=WVD,DC=digitech-eg,DC=local"
